...
public class StudentFeesListModel {
    String id,student_id,branch_id,fees_for,fees_date,fees,year,is_paid,student_name,student_code,student_class_id,type_name,class_name;


    public StudentFeesListModel(String id, String student_id, String branch_id, String fees_for, String fees_date, String fees, String year, String is_paid, String student_name, String student_code, String student_class_id, String type_name, String class_name) {
        this.id = id;
