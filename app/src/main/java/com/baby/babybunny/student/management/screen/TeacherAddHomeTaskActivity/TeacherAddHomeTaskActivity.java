package com.baby.babybunny.student.management.screen.TeacherAddHomeTaskActivity;
...
public class TeacherAddHomeTaskActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_add_home_task);
        ...
        toolname_id.setText("Add Home Task");
        ...
        switch (view.getId()){
            ...
            case R.id.tvsubmmitid:{
                ...
                if (Class_id.equalsIgnoreCase("0")){
                    MyToast.show(TeacherAddHomeTaskActivity.this,"Please select class",true);

                }else if (etn_subject.getText().toString().isEmpty()){
                    MyToast.show(TeacherAddHomeTaskActivity.this,"Please enter subject",true);

                }else if (etn_sub_details.getText().toString().isEmpty()){
                    MyToast.show(TeacherAddHomeTaskActivity.this,"Please enter content",true);

                }else {
                    apicallForinserthomtask(Class_id);
                }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i=0;i<jsonArray.length();i++){
                        ...
                        TeachetGetAllClassAdapter selectClassAdapter=new TeachetGetAllClassAdapter(TeacherAddHomeTaskActivity.this, teachetGetAllClassModels);
    ...
    public void apicallForinserthomtask(String Class_id){
       /* ProgressDialog pd = new ProgressDialog(this);
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, ApplicationConstant.Teacherurl_inserthomtask, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
              ...
              //  pd.dismiss();
                try {
                    ...
                    if (success.equalsIgnoreCase("0")){
                        MyToast.show(TeacherAddHomeTaskActivity.this,""+message,true);

                    }else {
                        tvsubmmitid.setVisibility(View.VISIBLE);
                        progress_bar.setVisibility(View.GONE);
                       // Toast.makeText(TeacherAddHomeTaskActivity.this, ""+message, Toast.LENGTH_SHORT).show();
                        MyToast.show(TeacherAddHomeTaskActivity.this,""+message,true);
                        Intent intent=new Intent(TeacherAddHomeTaskActivity.this, TeacherHomeTaskActivity.class);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
              ...
              //  hashMap.put("teacher_id", SessionManager.getTeacheridvalue());
                ...
                hashMap.put("homework_details",etn_sub_details.getText().toString());
